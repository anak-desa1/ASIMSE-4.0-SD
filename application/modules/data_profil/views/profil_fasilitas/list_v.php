                                     ...
                                     <?php
                                        ...
                                        foreach ($foto as $sk) :
                                         ...
                                         <tr>
                                             ...
                                             <td>
                                                 <a class="btn btn-sm btn-warning" title="Edit" id="edit_slide" data-bs-toggle="modal" data-bs-target="#editModal" data-id="<?= $sk['id']; ?>" data-judul="<?= $sk['judul']; ?>" data-text="<?= $sk['text']; ?>" data-status="<?= $sk['status']; ?>" data-gambar="<?= $sk['gambar']; ?>"><i class="fa fa-edit"></i> </a>
