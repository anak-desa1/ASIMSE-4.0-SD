            ...
            <div class="row">
                <div class="col-md-12">
                        ...
                        <div class="card-header p-2">
                            ...
                            <h3 class="btn btn-warning mb-3">Ubah Nilai Sikap</h3>
                        </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="tab-content">
                                <div class="col-md-12">
                                    ...
                                    <form action="<?= base_url('akademik_walikelas/nilai_sikap/update_sikap'); ?>" method="post">
                                        ...
                                        <div class="content">
                                            <div class="panel-body">
                                                <div class="table-responsive">
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                               <div class="form-group">
                                                                                   <textarea name="deskripsi[]" class="form-control" id="textarea" rows="3" cols="20" maxlength="100"><?= $ts['deskripsi']; ?></textarea>
                                                    ...
                                                    <button type="submit" class="btn btn-warning" id="tbsimpan"><i class="fa fa-check"></i> Ubah</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
