...
class Nilai_prestasi extends CI_Controller
{
    function __construct()
    {
        ...
        $data['idnya'] = "setmapel";
        $data['nama_form'] = "akademik_walikelas_km/nilai_prestasi";
    ...
    public function index()
    {
        if ($this->form_validation->run() == false) {
            ...
            $this->load->view('akademik_walikelas_km/nilai_prestasi/nilai_prestasi_css');
            $this->load->view('layout/header-bottom', $data);
            $this->load->view('layout/main-navigation', $data);
            $this->load->view('akademik_walikelas_km/nilai_prestasi/nilai_prestasi_v', $data);
            $this->load->view('layout/footer-top');
            $this->load->view('akademik_walikelas_km/nilai_prestasi/nilai_prestasi_js');
    ...
    public function input_prestasi($id)
    {
        if ($this->form_validation->run() == false) {
            ...
            $this->load->view('layout/header-bottom', $data);
            $this->load->view('layout/main-navigation', $data);
            $this->load->view('akademik_walikelas_km/nilai_prestasi/nilai_prestasi_input', $data);
            $this->load->view('layout/footer-top');
            $this->load->view('akademik_walikelas_km/nilai_prestasi/nilai_prestasi_js');
            $this->load->view('layout/footer-bottom');
            $this->benchmark->mark('code_end');
    ...
    public function tambah($id)
    {
        ...
        // die;
        $this->load->view('akademik_walikelas_km/nilai_prestasi/nilai_prestasi_css');
        $this->load->view('akademik_walikelas_km/nilai_prestasi/nilai_prestasi_tambah', $data);
        $this->load->view('akademik_walikelas_km/nilai_prestasi/nilai_prestasi_js');
    }
    ...
    public function simpan_data()
    {
        ...
        redirect('akademik_walikelas_km/nilai_prestasi/input_prestasi/' . $id);
    }
    ...
    public function del($id)
    {
        ...
        ');
        redirect('akademik_walikelas_km/nilai_prestasi/');
    }
    ...
    public function cetak()
    {
        ...
        // var_dump($data['data']);
        // die;       
        $this->load->view('akademik_walikelas_km/nilai_prestasi/nilai_prestasi_cetak', $data);
    }
}
