...
class Cetak_leger extends CI_Controller
{
    function __construct()
    {
        ...
        $this->load->model('Cetak_leger_model', 'leger');
    }
    ...
    public function index()
    {
        if ($this->form_validation->run() == false) {
            ...
            $this->load->view('akademik_walikelas_km/cetak_leger/leger_css');
            $this->load->view('layout/header-bottom', $data);
            $this->load->view('layout/main-navigation', $data);
            $this->load->view('akademik_walikelas_km/cetak_leger/leger_v', $data);
            $this->load->view('layout/footer-top');
            $this->load->view('akademik_walikelas_km/cetak_leger/leger_js');
    ...
    public function leger_tabel($id)
    {
        ...
        // die;    
        $this->load->view('akademik_walikelas_km/cetak_leger/leger_table', $data);
        $this->benchmark->mark('code_end');
    }
    ...
    public function detail($id)
    {
        ...
        // var_dump($data['absen_siswa']);
        // die;    
        $this->load->view('akademik_walikelas_km/cetak_leger/leger_detail', $data);
        $this->benchmark->mark('code_end');
    }
}
