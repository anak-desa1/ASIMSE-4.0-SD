...
class Nilai_absensi extends CI_Controller
{
    ...
    public function index()
    {
        if ($this->form_validation->run() == false) {
            ...
            $this->load->view('akademik_walikelas_km/nilai_absensi/nilai_absensi_css');
            $this->load->view('layout/header-bottom', $data);
            $this->load->view('layout/main-navigation', $data);
            $this->load->view('akademik_walikelas_km/nilai_absensi/nilai_absensi_v', $data);
            $this->load->view('layout/footer-top');
            $this->load->view('akademik_walikelas_km/nilai_absensi/nilai_absensi_js');
    ...
    public function tambah_pts()
    {
        if ($this->form_validation->run() == false) {
            ...
            $this->load->view('layout/header-bottom', $data);
            $this->load->view('layout/main-navigation', $data);
            $this->load->view('akademik_walikelas_km/nilai_absensi/nilai_absensi_tambah_pts', $data);
            $this->load->view('layout/footer-top');
            $this->load->view('akademik_walikelas_km/nilai_absensi/nilai_absensi_js');
            $this->load->view('layout/footer-bottom');
            $this->benchmark->mark('code_end');
    ...
    public function tambah_pas()
    {
        if ($this->form_validation->run() == false) {
            ...
            $this->load->view('layout/header-bottom', $data);
            $this->load->view('layout/main-navigation', $data);
            $this->load->view('akademik_walikelas_km/nilai_absensi/nilai_absensi_tambah_pas', $data);
            $this->load->view('layout/footer-top');
            $this->load->view('akademik_walikelas_km/nilai_absensi/nilai_absensi_js');
            $this->load->view('layout/footer-bottom');
            $this->benchmark->mark('code_end');
    ...
    public function absen_simpan_pts()
    {
        ...
        ');
        redirect('akademik_walikelas_km/nilai_absensi/');
    }
    ...
    public function cetak_pts()
    {
        ...
        // die;
        $this->load->view('akademik_walikelas_km/nilai_absensi/nilai_absensi_cetak_pts', $data);
        $this->benchmark->mark('code_end');
    }
    ...
    public function cetak_pas()
    {
        ...
        // var_dump($data['data']);
        // die;     
        $this->load->view('akademik_walikelas_km/nilai_absensi/nilai_absensi_cetak_pas', $data);
        $this->benchmark->mark('code_end');
    }
}
