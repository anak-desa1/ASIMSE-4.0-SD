...
class Biodata_rapor extends CI_Controller
{
    function __construct()
    {
        ...
        $data['url'] = "akademik_walikelas_km/biodata_rapor";
        $data['idnya'] = "setmapel";
    ...
    public function index()
    {
        if ($this->form_validation->run() == false) {
            ...
            $this->load->view('akademik_walikelas_km/biodata_rapor/biodata_rapor_css');
            $this->load->view('layout/header-bottom', $data);
            $this->load->view('layout/main-navigation', $data);
            $this->load->view('akademik_walikelas_km/biodata_rapor/biodata_rapor_v', $data);
            $this->load->view('layout/footer-top');
            $this->load->view('akademik_walikelas_km/biodata_rapor/biodata_rapor_js');
    ...
    public function cover($id, $target)
    {
        if ($this->form_validation->run() == false) {
            ...
            $this->load->view('layout/header-bottom', $data);
            $this->load->view('layout/main-navigation', $data);
            $this->load->view('akademik_walikelas_km/biodata_rapor/biodata_rapor_cover', $data);
            $this->load->view('layout/footer-top');
            $this->load->view('akademik_walikelas_km/biodata_rapor/biodata_rapor_js');
            $this->load->view('layout/footer-bottom');
            $this->benchmark->mark('code_end');
    ...
    public function data_sekolah($id, $target)
    {
        if ($this->form_validation->run() == false) {
            ...
            $this->load->view('layout/header-bottom', $data);
            $this->load->view('layout/main-navigation', $data);
            $this->load->view('akademik_walikelas_km/biodata_rapor/biodata_rapor_sekolah', $data);
            $this->load->view('layout/footer-top');
            $this->load->view('akademik_walikelas_km/biodata_rapor/biodata_rapor_js');
            $this->load->view('layout/footer-bottom');
            $this->benchmark->mark('code_end');
    ...
    public function data_siswa($id, $target)
    {
        ...
        $this->load->view('layout/main-navigation', $data);
        $this->load->view('akademik_walikelas_km/biodata_rapor/biodata_rapor_siswa', $data);
        $this->load->view('layout/footer-top');
        $this->load->view('akademik_walikelas_km/biodata_rapor/biodata_rapor_js');
        $this->load->view('layout/footer-bottom');
        $this->benchmark->mark('code_end');
    ...
    public function data_panduan()
    {
        ...
        $this->load->view('layout/header-notif');
        $this->load->view('layout/main-navigation', $data);
        $this->load->view('akademik_walikelas_km/biodata_rapor/biodata_rapor_panduan', $data);
        $this->load->view('layout/footer-top');
        $this->load->view('akademik_walikelas_km/biodata_rapor/biodata_rapor_js');
        $this->load->view('layout/footer-bottom');
        $this->benchmark->mark('code_end');
    ...
    public function mpdf($id, $target)
    {
        ...
        $mpdf->SetHTMLFooter('<hr> <table width="100%" style="font-size: 8pt;">
            <tr>
                <td width="25%">{PAGENO}/{nbpg} | ASIMSE 4.0</td>
                <td width="0%" align="center"></td>
                <td width="75%" style="text-align: right;  "><p>' . 'Rapor - ' . $siswa['nis'] . ' | ' . $siswa['nama'] . ' | ' . $kelas['rombel'] . ' | ' . $sekolah['nama_sekolah'] . ' </p></td>
            </tr>
        </table>');
        $html1 = $this->load->view('akademik_walikelas_km/biodata_rapor/biodata_rapor_pdf_1', $data, TRUE);
        ...
        $html2 = $this->load->view('akademik_walikelas_km/biodata_rapor/biodata_rapor_pdf_2', $data, TRUE);
        ...
        $html3 = $this->load->view('akademik_walikelas_km/biodata_rapor/biodata_rapor_pdf_3', $data, TRUE);
        ...
        $html4 = $this->load->view('akademik_walikelas_km/biodata_rapor/biodata_rapor_pdf_4', $data, TRUE);
