...
class Nilai_catatan extends CI_Controller
{
    function __construct()
    {
        ...
        $data['url'] = "akademik_walikelas_km/nilai_catatan";
        $data['idnya'] = "setmapel";
    ...
    public function index()
    {
        if ($this->form_validation->run() == false) {
            ...
            $data['title'] = 'Input Catatan';
            $data['home'] = 'Rapor Walikelas KM';
            ...
            $this->load->view('akademik_walikelas_km/nilai_catatan/nilai_catatan_css');
            $this->load->view('layout/header-bottom', $data);
            $this->load->view('layout/main-navigation', $data);
            $this->load->view('akademik_walikelas_km/nilai_catatan/nilai_catatan_v', $data);
            $this->load->view('layout/footer-top');
            $this->load->view('akademik_walikelas_km/nilai_catatan/nilai_catatan_js');
    ...
    public function tambah_pts()
    {
        if ($this->form_validation->run() == false) {
            ...
            $this->load->view('layout/header-bottom', $data);
            $this->load->view('layout/main-navigation', $data);
            $this->load->view('akademik_walikelas_km/nilai_catatan/nilai_catatan_tambah_pts', $data);
            $this->load->view('layout/footer-top');
            $this->load->view('akademik_walikelas_km/nilai_catatan/nilai_catatan_js');
            $this->load->view('layout/footer-bottom');
            $this->benchmark->mark('code_end');
    ...
    public function tambah_pas()
    {
        if ($this->form_validation->run() == false) {
            ...
            $this->load->view('layout/header-bottom', $data);
            $this->load->view('layout/main-navigation', $data);
            $this->load->view('akademik_walikelas_km/nilai_catatan/nilai_catatan_tambah_pas', $data);
            $this->load->view('layout/footer-top');
            $this->load->view('akademik_walikelas_km/nilai_catatan/nilai_catatan_js');
            $this->load->view('layout/footer-bottom');
            $this->benchmark->mark('code_end');
    ...
    public function tambah_pat()
    {
        ...
        $this->load->view('layout/header-bottom', $data);
        $this->load->view('layout/main-navigation', $data);
        $this->load->view('akademik_walikelas_km/nilai_catatan/nilai_catatan_tambah_pat', $data);
        $this->load->view('layout/footer-top');
        $this->load->view('akademik_walikelas_km/nilai_catatan/nilai_catatan_js');
        $this->load->view('layout/footer-bottom');
        $this->benchmark->mark('code_end');
    ...
    public function simpan_pts()
    {
        ...
        ');
        redirect('akademik_walikelas_km/nilai_catatan/');
    }
    ...
    public function cetak_pts()
    {
        ...
        // var_dump($data['data']);
        // die;     
        $this->load->view('akademik_walikelas_km/nilai_catatan/nilai_catatan_cetak_pts', $data);
        $this->benchmark->mark('code_end');
    }
    ...
    public function cetak_pas()
    {
        ...
        // var_dump($data['data']);
        // die;     
        $this->load->view('akademik_walikelas_km/nilai_catatan/nilai_catatan_cetak_pas', $data);
        $this->benchmark->mark('code_end');
    }
    ...
    public function cetak_pat()
    {
        ...
        // var_dump($data['data']);
        // die;     
        $this->load->view('akademik_walikelas_km/nilai_catatan/nilai_catatan_cetak_pat', $data);
        $this->benchmark->mark('code_end');
    }
}
