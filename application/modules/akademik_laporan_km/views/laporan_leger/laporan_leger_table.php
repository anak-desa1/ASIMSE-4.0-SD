<div class="card-header">
    ...
    <a target="_blank" class="btn btn-info btn-sm" style="float: right;" href="<?= base_url() ?>akademik_laporan_km/laporan_leger/detail/<?= $data['rombel'] ?>"><i class="fa fa-print"></i> cetak</a>
</div>    
