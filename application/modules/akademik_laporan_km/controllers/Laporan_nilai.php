...
class Laporan_nilai extends CI_Controller
{
    ...
    public function index()
    {
        if ($this->form_validation->run() == false) {
            ...
            $this->load->view('akademik_laporan_km/laporan_nilai/laporan_nilai_css');
            $this->load->view('layout/header-bottom', $data);
            $this->load->view('layout/main-navigation', $data);
            $this->load->view('akademik_laporan_km/laporan_nilai/laporan_nilai_v', $data);
            $this->load->view('layout/footer-top');
            $this->load->view('akademik_laporan_km/laporan_nilai/laporan_nilai_js');
    ...
    public function tabel_nilai($id,$target)
    {
        ...
        $this->load->view('akademik_laporan_km/laporan_nilai/laporan_nilai_table', $data);
    }
    ...
    public function nilai_sumatif($id)
    {
        if ($this->form_validation->run() == false) {
            ...
            $data['nilai_sas'] = $this->laporan_nilai->get_detailnilai_pas($id);
            ...
            $this->load->view('akademik_laporan_km/laporan_nilai/laporan_nilai_css');
            $this->load->view('akademik_laporan_km/laporan_nilai/nilai_asesmen_sumatif_v', $data);
            $this->load->view('akademik_laporan_km/laporan_nilai/laporan_nilai_js');
            $this->benchmark->mark('code_end');
        } else {
        }
