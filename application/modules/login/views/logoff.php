        ...
        <div class="col-lg-6">
            <div class="card shadow-lg border-0 rounded-lg p-2">
                ...
                <div class="card-body">
                    ...
                    <form class="form" id="" method="POST" action="<?= base_url('auth/auth'); ?>">
                        <?= csrf() ?>
                        <div class="form-group row">
                            <div class="input-group">
                                ...
                                <input class="form-control py-4" name="email_pegawai" id="email_pegawai" type="email" placeholder="Enter Email" value="<?= set_value('email_pegawai') ?>" />
                            </div>
                        </div>
