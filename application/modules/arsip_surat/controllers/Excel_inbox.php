...
class Excel_inbox extends CI_Controller
{
	...
	{
		// include APPPATH . 'third_party/PHP_Excel/PHPExcel.php';
		$excel = new PHPExcel();
		...
		$excel->setActiveSheetIndex(0)->setCellValue('D6', "Perihal");
		$excel->setActiveSheetIndex(0)->setCellValue('E6', "Pengirim");
		$excel->setActiveSheetIndex(0)->setCellValue('F6', "Tujuan");
		$excel->setActiveSheetIndex(0)->setCellValue('G6', "Disposisi");
		$excel->setActiveSheetIndex(0)->setCellValue('H6', "Status");
		...
		foreach ($inbox as $row) {
			...
			$excel->setActiveSheetIndex(0)->setCellValue('D' . $numrow, $row['perihal']);
			$excel->setActiveSheetIndex(0)->setCellValue('E' . $numrow, $row['pengirim']);
			$excel->setActiveSheetIndex(0)->setCellValue('F' . $numrow, $row['tujuan']);
			$excel->setActiveSheetIndex(0)->setCellValue('G' . $numrow, $row['disposisi']);

			if ($row['is_approved'] == 1) {
				$excel->setActiveSheetIndex(0)->setCellValue('H' . $numrow, 'Diterima');
			} elseif ($row['is_approved'] == 0) {
				$excel->setActiveSheetIndex(0)->setCellValue('H' . $numrow, 'Terkirim');
			} elseif ($row['is_approved'] == 2) {
				$excel->setActiveSheetIndex(0)->setCellValue('H' . $numrow, 'Ditolak');
			}
