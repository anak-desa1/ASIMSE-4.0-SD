...

{
    ...
    public function nilai_simpan()
    {
        ...
        for ($i = 0; $i < count($id_siswa); $i++) {
            ...
            $cek = $this->db->get_where('t_nilai_p', ['id_siswa' => $id_siswa[$i], 'id_guru_mapel' => $p['id_guru_mapel'], 'id_mapel_kd' => $p['id_mapel_kd'], 'jenis' => $p['jenis'], 'tasm' => $p['tasm'], 'penilaian' => $p['penilaian']])->row_array();
            // var_dump($cek);
            // die;
