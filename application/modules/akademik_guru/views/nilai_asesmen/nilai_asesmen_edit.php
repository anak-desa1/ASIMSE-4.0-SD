                    ...
                    <div class="card card-info">
                        ...
                        <div class="card-body">
                            ...
                            <ul class="list-group">
                                ...
                                ?>
                                        <li class="list-group-item"><a href="#"><i class="fa fa-chevron-right"></i> KD - <?= $c['no_kd_1']; ?> - <?= $c['no_kd_2']; ?> </a></li>
                                <?php
                                        }
                                } else {
                    ...
                    <div class="card">
                        ...
                        <div class="card-header p-2">
                            <?php if ($pegawai['bagian_shift'] == 'ON') : ?>
                                <a class="btn btn-info mb-3" href="<?= site_url('akademik_guru/input_nilai/tambah_pas/') ?><?= $data['mapel_id'] ?>"><i class="fa fa-arrow-circle-left"></i> Kembali</a>
                            <?php endif ?>
                        </div><!-- /.card-header -->
                        <div class="card-body">
                                ...
                                <div class="active tab-pane" id="activity">
                                    ...
                                    <div class="row">
                                        <div class="table-responsive">
                                            <form method="post" action="<?= base_url() . $this->uri->segment(1, 0) . $this->uri->slash_segment(2, 'both') . 'update_pas_simpan' ?>" role="form" id="form-action" enctype="multipart/form-data">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <?php foreach ($nilai as $c) :
                                                                if ($c['id_siswa'] == $h['id_siswa']) { ?>
                                                                    <td class="">
                                                                        Kopetensi Dasar - <?= $c['no_kd_1']; ?> - <?= $c['no_kd_2']; ?>
                                                                    </td>
                                                            <?php }
                                                            endforeach ?>
                                                        </tr>
                                                                        ...
                                                                        <td class="text-center">
                                                                            <div class="input-group input-group-sm mb-0">
                                                                                <div class="text-center">
                                                                                    ...
                                                                                    <input type="hidden" name="mapel_id" value="<?= $data['mapel_id'] ?>"> <input type="hidden" name="kd_id" value="<?= $c['kd_id'] ?>">
