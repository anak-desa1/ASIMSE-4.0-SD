                ...
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-header p-2">
                            ...
                            <a class="btn btn-secondary mb-3" href="<?= site_url('akademik_guru/input_nilai/tambah_pas/') ?><?= $data['mapel_id'] ?>"><i class="fa fa-plus-circle"></i> Input Nilai</a>
                            <a class="btn btn-success mb-3" href="<?= site_url('akademik_guru/input_nilai/export_excel_pas/') ?><?= $data['mapel_id'] ?>"><i class="fa fa-download"></i> Export Excel </a>
                            <a class="btn btn-primary mb-3" href="<?= site_url('akademik_guru/input_nilai/import_excel_pas/') ?><?= $data['mapel_id'] ?>"><i class="fa fa-upload"></i> Import Excel</a>
                            <!-- <a class="btn btn-warning mb-3" href="<?= site_url('akademik_guru/input_nilai/cetak_pas/') ?><?= $data['mapel_id'] ?>" target="_blank"><i class="fa fa-print"></i> cetak</a> -->
