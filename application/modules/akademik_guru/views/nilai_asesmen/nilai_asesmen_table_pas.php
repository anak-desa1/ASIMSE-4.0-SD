 <form method="post" action="<?= base_url() . $this->uri->segment(1, 0) . $this->uri->slash_segment(2, 'both') . 'nilai_pas_simpan' ?>" role="form" id="form-action" enctype="multipart/form-data">
             ...
             <div class="col-md-12">
                 <div class="row">                    
                     <div class="col-md-4 form-group">
                         <label>Kompetensi Dasar<span class="symbol required"> </span></label>
                         <select class="form-control select2" style="width: 100%;" id="id_mapel_kd" name="id_mapel_kd" required>
                             ...
                             <?php foreach ($kd as $kel) {
                                    echo '<option value="' . $kel['kd_id'] . '">' . $kel['no_kd_1'] . '-' . $kel['no_kd_2'] . '</option>';
                                } ?>
                         </select>
                     </div>                     
                 </div>
