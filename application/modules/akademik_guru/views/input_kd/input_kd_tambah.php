                                ...
                                <form method="post" action="<?= base_url() . $this->uri->segment(1, 0) . $this->uri->slash_segment(2, 'both') . 'kd_simpan' ?>" role="form" id="form-action" enctype="multipart/form-data">
                                          ...
                                          <div class="form-group" id="kd">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-3">
                                                    <h5 class="card-title">No.KD</h5>
                                                    <input type="text" class="form-control" name="no_kd_1" id="no_kd" placeholder="No KD">
                                                </div>
                                                <div class="col-md-8">
                                                    <h5 class="card-title">Deskripsi.KD</h5>
                                                    <div class="form-group">
                                                        <textarea name="nama_kd_1" class="form-control" id="textarea" rows="3" cols="20" maxlength="100"></textarea>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-3">
                                                    <h5 class="card-title">No.KD</h5>
                                                    <input type="text" class="form-control" name="no_kd_2" id="no_kd" placeholder="No KD">
                                                </div>
                                                <div class="col-md-8">
                                                    <h5 class="card-title">Deskripsi.KD</h5>
                                                    <textarea name="nama_kd_2" class="form-control" id="textarea" rows="3" cols="20" maxlength="100"></textarea>
                                                    <div id="textarea_feedback"></div>
                                                </div>
                                          </div>    
