             ...
             <div class="modal-content">
                 ...
                 <div class="col-md-12">
                     <div class="card">
                         ...
                         <div class="card-body">
                             <form method="post" action="<?= base_url() ?>akademik_guru/input_kd/kd_ubah_2" enctype="multipart/form-data">
                                 ...
                                 <div class="row">                                     
                                     <div class="col-md-2">
                                         <div class="form-group">
                                             ...
                                             <input type="text" name="no_kd_2" value="<?= $kd['no_kd_2'] ?>" class="form-control" readonly>
                                         </div>
                                     </div>
                                     <div class="col-md-2">
                                         <div class="form-group">
                                     ...
                                     <div class="col-md-10">
                                         <div class="form-group">
                                             ...
                                             <textarea name="nama_kd_2" class="form-control" id="textarea" rows="3" cols="20" maxlength="100"><?= $kd['nama_kd_2'] ?></textarea>
