...
<script src="<?= base_url() ?>panel/plugins/js/moment.js"></script>
<script src="<?= base_url() ?>panel/plugins/js/bootstrap-datetimepicker.min.js"></script>
<script src="<?= base_url() ?>panel/plugins/js/jquery.price_format.min.js"></script>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $("#kode_brg").keyup(function() {
            ...
            $.ajax({
                type: "POST",
                url: "<?= base_url() . $this->uri->segment(1, 0) ?>/get_barang",
                data: kobar,
