                                    ...
                                    <div class="row">                                        
                                        ...
                                        <div class="col-sm-8"> 
                                            <div class="card" style="border-top: 8px solid #035AA6;border-bottom: 8px solid #035AA6;border-right: 4px solid #035AA6;border-top-left-radius: 16px;border-bottom-left-radius: 16px;box-shadow: 0px 3px 6px 0px #222;">
                                                ...
                                                <div class="card-body">
                                                    <div class="panel-body">
                                                        ...
                                                        ?>
                                                        <span id="clock">&nbsp;</span>
                                                        <form method="post" action="<?= base_url() . $this->uri->segment(1, 0) ?>/cek_id_pulang" role="form" id="form-action" enctype="multipart/form-data">
                                                        <div class="card-body">                                                        
                                            ...
                                            <div class="card" style="border-top: 8px solid #035AA6;border-bottom: 8px solid #035AA6;border-right: 4px solid #035AA6;border-top-left-radius: 16px;border-bottom-left-radius: 16px;box-shadow: 0px 3px 6px 0px #222;">
                                                ...
                                                <br>
                                                    <div class="panel-body">
                                                    <?php foreach ($siswa_pulang as $sp) : ?>
                                                        <div class="alert alert-primary" role="alert">
                                                            <div class="row">
                                                                <div><img style="margin-left: -180px; border: 1px solid #fff; position: absolute; margin-top: -12px; width: 50px; height: 50px; overflow: hidden; border-radius: 15%;" class="img-responsive img" src="<?= base_url() ?>panel/assets/img/foto/<?= $sp['nis'] ?>.png"></div>
                                                                <div><?= $sp['nama']?></div>
                                                            </div>                                                        
                                                        </div>                                                  
                                                    <?php endforeach ?>
