                    ...
                    <div class="card-body">
                        <?php if ($pegawai['kd_sekolah'] == $pegawai['kd_sekolah']) : ?>
                            <form method="post" action="<?= base_url() . $this->uri->segment(1, 0) . $this->uri->slash_segment(2, 'both') . 'simpan_data' ?>" role="form" id="form-action" enctype="multipart/form-data">
                                <div class="row">
                                    <input type="hidden" name="ta" value="<?= $tahun['tahun'] ?>">
                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        <div class="form-group">
                                            <label>Jenis Prestasi <span class="symbol required"> </span></label>
                                            <input type="text" class="form-control" name="jenis">
                                        </div>
                                        <div class="form-group">
                                            <label>Prestasi <span class="symbol required"> </span></label>
