                ...
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-header p-2">
                            ...
                            <?php if ($semester == 1) { ?>
                                <a class="btn btn-info mb-3" href="<?= base_url('akademik_walikelas/nilai_catatan/tambah_pas/'); ?>"> <i class="fa fa-address-book"></i> Catatan Walikelas</a>
                            ...
                            <?php  } else { ?>
                                <a class="btn btn-info mb-3" href="<?= base_url('akademik_walikelas/nilai_catatan/tambah_pat/'); ?>"> <i class="fa fa-address-book"></i> Catatan Walikelas</a>
