                            ...
                            <tbody>
                                ...
                                <?php foreach ($tahun->result() as $r) : ?>
                                    <tr>
                                        ...
                                        <td><?= $r->tahun_aktif; ?></td>
                                        <td>
                                            <a class="btn btn-warning" href="" data-tahun_aktif="<?= $r->tahun_aktif; ?>" data-id="<?= $r->id_tahun; ?>" data-bs-toggle="modal" data-bs-target="#editModal" title="Edit"><i class="bi bi-pencil-square"></i></a>
                                            <a href="<?= base_url('data_persiapan/persiapan_tahun/delTahun/') . $r->id_tahun; ?>" class="btn btn-danger"><i class="bi bi-x-circle-fill"></i></a>
                                        </td>
                                    </tr>
                                    <?php $i++; ?>
                                <?php endforeach; ?>
