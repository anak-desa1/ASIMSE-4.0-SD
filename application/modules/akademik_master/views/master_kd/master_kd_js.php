...
<script type="text/javascript">
    ...
    $('.btn-action-1').on('click', function() {
        ...
        xhr = $.ajax({
            method: "POST",
            url: "<?= base_url() . $this->uri->segment(1, 0) . $this->uri->slash_segment(2, 'both') ?>tambah_p/<?= ucwords($this->uri->segment(4, 0)) ?>/<?= ucwords($this->uri->segment(5, 0)) ?>",
            data: "jenis=tambah",
    ...
    $('.btn-action-2').on('click', function() {
        ...
        xhr = $.ajax({
            method: "POST",
            url: "<?= base_url() . $this->uri->segment(1, 0) . $this->uri->slash_segment(2, 'both') ?>tambah_k/<?= ucwords($this->uri->segment(4, 0)) ?>/<?= ucwords($this->uri->segment(5, 0)) ?>",
            data: "jenis=tambah",
            success: function(response) {
                $('.tampil-modal').html(response);
                $('.modal-action').modal({
    ...
    $('.btn-action-3').on('click', function() {
        show_loading();
        id = $(this).data('id');
        xhr = $.ajax({
            method: "POST",
