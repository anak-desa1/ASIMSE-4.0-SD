...
class Master_kelas_model extends CI_Model

{
    // tampil data
    var $table = 'm_kelas u';
    var $column_order = array('', 'u.tingkat', 'u.nama'); //set order berdasarkan field yang di mau
    var $column_search = array('u.tingkat', 'u.nama'); //set field yang bisa di search
