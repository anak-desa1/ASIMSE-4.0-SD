...
<body>
    ...
    <div style="text-align: center;" >        
        ...
        <div style="margin-left: 250px; text-align: justify;"><?= $publish['kata_pembuka'] ?></div>
        <div style="padding-left: 250px; margin-right:250px; text-align: center;" class="col-md-12">        
        ...
        <div style="margin-left: 250px; margin-right:80px; text-align: justify;"><?= $publish['kata_isi'] ?></div>        
        ...
        <div style="margin-left: 250px; text-align: justify;"><?= $publish['kata_penutup'] ?></div>
    ...
    <table width="100%">
            <tr>
                ...
                <td style="text-align: center">
                    ...
                    <br>
                    <u><b><?= $sekolah['sebutan_kepala'] ?></b></u>
                    <!--<br>-->
                    <!--PEMBINA <br>-->
                    <!--NIP. <?= $sekolah['nip'] ?>                    -->
                </td>
