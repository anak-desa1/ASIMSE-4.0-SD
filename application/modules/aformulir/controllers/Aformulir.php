...
class Aformulir extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $data['p_transportasi']  = array("" => "Pilih Transportasi", "Jalan Kaki" => "Jalan Kaki", "Angkutan Umum" => "Angkutan Umum", "Sepeda Motor" => "Sepeda Motor", "Sepeda" => "Sepeda");
    ...
    public function mpdf_cetak()
    {
        ...
        $html1 = $this->load->view('aformulir/data_diri_pdf', $data, TRUE);
        ...
        $html2 = $this->load->view('aformulir/surat_peryantaan_pdf_1', $data, TRUE);
        ...
        //     </tr>
        // </table>');
        // $html3 = $this->load->view('aformulir/surat_peryantaan_pdf_2', $data, TRUE);
