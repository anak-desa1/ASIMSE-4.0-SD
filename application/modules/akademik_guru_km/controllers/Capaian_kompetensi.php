...
class Capaian_kompetensi extends CI_Controller
{
    ...
    public function index()
    {
        if ($this->form_validation->run() == false) {
            ...
            $this->load->view('akademik_guru_km/capaian_kompetensi/capaian_kompetensi_css');
            $this->load->view('layout/header-bottom', $data);
            $this->load->view('layout/main-navigation', $data);
            $this->load->view('akademik_guru_km/capaian_kompetensi/capaian_kompetensi_v', $data);
            $this->load->view('layout/footer-top');
            $this->load->view('akademik_guru_km/capaian_kompetensi/capaian_kompetensi_js');
    ...
    public function nilai_sumatif($id)
    {
        if ($this->form_validation->run() == false) {
            ...
            $this->load->view('layout/header-bottom', $data);
            $this->load->view('layout/main-navigation', $data);
            $this->load->view('akademik_guru_km/capaian_kompetensi/capaian_kompetensi_detail', $data);
            $this->load->view('layout/footer-top');
            $this->load->view('akademik_guru_km/capaian_kompetensi/capaian_kompetensi_js');
            $this->load->view('layout/footer-bottom');
            $this->benchmark->mark('code_end');
