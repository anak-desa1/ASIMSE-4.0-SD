                                ...
                                <tbody>
                                    ...
                                    foreach ($sch as $sk) :
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a class="btn btn-sm btn-warning" title="Edit" id="edit_sekolah" data-bs-toggle="modal" data-bs-target="#editModal" data-npsn="<?= $sk['npsn']; ?>" data-nama_sekolah="<?= $sk['nama_sekolah']; ?>" data-alamat="<?= $sk['alamat']; ?>" data-status="<?= $sk['status']; ?>"><i class="bi bi-pencil-square"></i></a>
                                                <a href="<?= base_url() ?>ppdb_setting/deldata/<?= $sk['npsn'] ?>" class="btn btn-sm btn-danger btn-hapus"><i class="bi bi-trash"></i></a>
