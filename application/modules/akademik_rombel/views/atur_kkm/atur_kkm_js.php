...
<script type="text/javascript">
    ...
    $('.btn-action').on('click', function() {
        ...
        xhr = $.ajax({
            method: "POST",
            url: "<?= base_url() . $this->uri->segment(1, 0) . $this->uri->slash_segment(2, 'both') ?>tambah/<?= $tampil['tingkat'] ?>",
            data: "jenis=tambah",
    ...
    function validate_form() {
        ...
        $('#form-action').validate({
            ...
            submitHandler: function() {
                ...
                xhr = $.ajax({
                    method: "POST",
                    url: "<?= base_url() . $this->uri->segment(1, 0) . $this->uri->slash_segment(2, 'both') ?>simpan_kkm",
                    data: formdata,
                    success: function(response) {
