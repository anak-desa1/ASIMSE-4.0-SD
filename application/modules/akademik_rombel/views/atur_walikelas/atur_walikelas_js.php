...
<script type="text/javascript">
    ...
    function validate_form() {
        ...
        $('#form-action').validate({
            ...
            submitHandler: function() {
                ...
                xhr = $.ajax({
                    method: "POST",
                    url: "<?= base_url() . $this->uri->segment(1, 0) . $this->uri->slash_segment(2, 'both') ?>simpan_walikelas",
                    data: formdata,
                    success: function(response) {
    ...
    $(document).ready(function() {
        table_data = $('#example1').DataTable({
            ...
            "ajax": {
                "url": "<?= base_url() . $this->uri->segment(1, 0) . $this->uri->slash_segment(2, 'leading') . "/atur_walikelas"; ?>",
                "type": "POST"
            },
