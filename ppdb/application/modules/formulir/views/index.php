                        ...
                        <div class="author-box-details">
                          ...
                          <div class="tab-content" id="myTabContent2">
                            <div class="tab-pane fade show active" id="home3" role="tabpanel" aria-labelledby="home-tab3">
                              <br>
                              <form action="<?= base_url() ?>formulir/simpandatadiri" method="post">
                            ...
                            <div class="tab-pane fade" id="contact3" role="tabpanel" aria-labelledby="contact-tab3">
                              <br>
                              <form action="<?= base_url() ?>formulir/simpanalamat" method="post">
                                <input type="hidden" name="id_daftar" class="form-control" value="<?= $siswa['id_daftar'] ?>">
                            ...
                            <div class="tab-pane fade" id="profile3" role="tabpanel" aria-labelledby="profile-tab3">
                              <br>
                              <form action="<?= base_url() ?>formulir/simpanortu" method="post">
                                <input type="hidden" name="id_daftar" class="form-control" value="<?= $siswa['id_daftar'] ?>">
